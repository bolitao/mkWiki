...
Group 1:
group name = group1
disk total space = 99,773 MB
disk free space = 73,268 MB
...
current trunk file id = 0
        ...
        Storage 1:
                id = 192.168.79.131
                ip_addr = 192.168.79.131  ACTIVE
                http domain =
                version = 6.07
                join time = 2021-03-14 18:44:00
                up time = 2021-03-14 18:44:52
                total storage = 99,773 MB
                free storage = 73,268 MB
                upload priority = 10
                store_path_count = 1
                ...
                last_heart_beat_time = 2021-03-14 18:45:23
    ...
    ``` shell
    # 测试，有文件路径返回表示成功，如：group1/M00/00/00/xx.tar.gz
